...
- Live Site URL: [Live Url](https://huddlecurvedaljok.netlify.app/)
...
This section using svelte.js as framework but still not implement UI for mobile design. next i will implement for mobile design
